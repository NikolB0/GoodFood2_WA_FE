            ...
            <nav class="navbar navbar-expand-lg navbar-light mb-2">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <form class="form-inline my-2 my-lg-0 mr-auto ml-5" style="margin-left: 180px;">
                  <input v-model="store.searchTerm" class="form-control mr-sm-2" type="search" placeholder="Pretraga..."
                    aria-label="Search" />
                </form>
                <router-link v-if="!auth.authenticated" class="btn btn-info my-2 my-sm-0 mr-2" style="margin-left:10px;"
                  to="/login">
                  Login
                </router-link>
                ...
                <router-link v-if="!auth.authenticated" class="btn btn-outline my-2 my-sm-0 mr-2" to="/signup">
                  Signup
                </router-link>
              </div>
            </nav>
